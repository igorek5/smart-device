...
var validateInputs = function validateInputs(form) {
  ...
  var flagName = checkFieldLength(nameInput, MIN_NAME_LENGTH);
  var flagPhone = checkFieldLength(phoneInput, MIN_PHONE_LENGTH);
  var flagCheckBox = checkCheckBox(checkBoxInput);
